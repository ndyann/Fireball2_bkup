 ...
 *
 * The function CreateDisplay() creates a display window, where a 8-bit grayscale as well as a 24-bit color picture can be displayed.
 *
 * \param	nColor	 	Color depth of window in bit (8 or 24).
...
int CreateDisplay(int nColor, const unsigned int nWidth, const unsigned int nHeight);
