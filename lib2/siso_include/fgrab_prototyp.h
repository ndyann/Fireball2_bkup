 ...
 * and can be displayed by microDiagnosis or microDisplay. An additional possibility for identifying
 ...
 * easiest way to find out the mapping from boards to their board id is using microDiagnosis which
 ...
 * VA generated HAPs and BaseX1 applets do not support slave mode.
 *
 ...
 * \param	FileName	Applet name for initialization.
 * \param	BoardIndex	Logical number of the board.
 * \param	isSlave		If slave mode should be used.
 *
 * \returns	Initialized pointer on the data structure of the FrameFrabber.
 * \retval	NULL The initialization failed.
 *
 ...
 *
 *
 * \returns	Runtime version of the SDK running, i. e. "3.4.0"
 */
 ...
 *
 * \retval	NULL An error has occured. Use Fg_getLastErrorDescription() for more information.
 */
...
/**
 * \brief	Get id number of currently running applet.
 *
 * \param	Fg		frame grabber to use
...
* \retval FG_INVALID_PARAMETER enable is not 0 or 1
*/
