...
static char* PCO_ERROR_DRIVER_TXT[] = 
{
  ...
  "firmware does not support camera head.",        // 0x8000202E  PCO_ERROR_DRIVER_HEAD_BOARD_MISMATCH
  "camera head is not recognized correctly.",      // 0x8000202F  PCO_ERROR_DRIVER_HEAD_VERIFY_FAILED
